...
<body class="d-flex flex-column min-vh-100">
    ...
    $consulta_datos = "SELECT * FROM usuarios WHERE dni = '$dni'";
                    ...
                    <form action="actualizarDatos.php" method="POST">
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" id="nombre" name="nombre" value="<?php if (isset($nombre)) echo $nombre; ?>">
                            </div>
                            <div class="col-md-6 mb-3">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" id="dni" name="dni" value="<?php if (isset($dni)) echo $dni; ?>" maxlength="9" readonly>
                            </div>
                            <div class="col-md-6 mb-3">
                                <label for="telefono" class="form-label">Teléfono</label>
                                <input type="tel" class="form-control" id="telefono" name="telefono" value="<?php if (isset($telefono)) echo $telefono; ?>" maxlength="9">
                            </div>
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="direccion" name="direccion" value="<?php if (isset($direccion)) echo $direccion; ?>">
                        </div>
                ...
                <div class="caja mb-4">
                    ...
                    <form action="actualizarDatos.php" method="POST">
                        ...
                        if (isset($_SESSION['error'])) {
                            echo "<div class='text-danger small mb-2'>La contraseña antigua no es correcta..</div>";
